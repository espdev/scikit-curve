...
def _solve_segments_intersection(
    ...
    So, the equations for two n-dimensional segments intersection problem are
       ...
       (y2(2) - y2(1))*t2 = y0 - y2(1)
                     ...
       (n1(2) - n1(1))*t1 = n0 - n1(1)
       (n2(2) - n2(1))*t2 = n0 - n2(1)

    Rearranging and writing in matrix form,
                        A                            t         b
     [x1(2)-x1(1)       0       -1   0 ...  0        [t1      [-x1(1)
           0       x2(2)-x2(1)  -1   0 ...  0    *    t2   =   -x2(1)
      y1(2)-y1(1)       0        0  -1 ...  0         x0       -y1(1)
           0       y2(2)-y2(1)   0  -1 ...  0         y0       -y2(1)
                       ...                           ...        ...
      n1(2)-n1(1)       0        0   0 ... -1         n0       -n1(1)
           0       n2(2)-n2(1)   0   0 ... -1]        n0]      -n2(1)]
